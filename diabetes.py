...
Original file is located at
    https://colab.research.google.com/drive/1vEEPZ9KkxW_tLiqINZst__M6PRQIjLDS
"""
...
sns.countplot(x='Outcome', data=df, ax=ax[1]) # Changed 'Outcome' to x='Outcome'
...
pickle.dump(svm_model, open('nb_model.pkl', 'wb')) #naive  bayes has the highest accuracy
